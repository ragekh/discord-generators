    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md border border-gray-100 mb-6">
          ...
          <div className="mb-4">
            <label className="block mb-2 font-semibold">Server Theme/Purpose:</label>
            <textarea
              value={serverTheme}
        ...
        {result && !loading && (
          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4">Welcome Message Best Practices</h2>
            ...
            <div className="mt-8 bg-[#F0F9FF] border border-[#B9E6FE] rounded-lg p-4">
              <h3 className="font-semibold text-[#026AA2] mb-2">Why Welcome Messages Matter</h3>
